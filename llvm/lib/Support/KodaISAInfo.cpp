//===-- KodaISAInfo.cpp - Koda Arch String Parser --------------===//
//
...
struct KodaExtensionVersion {
  unsigned Major;
  unsigned Minor;
};

struct KodaSupportedExtension {
  const char *Name;
  /// Supported version.
  KodaExtensionVersion Version;
};
...
static const KodaSupportedExtension SupportedExtensions[] = {
    {"i", KodaExtensionVersion{2, 0}},
    {"e", KodaExtensionVersion{1, 9}},
    {"m", KodaExtensionVersion{2, 0}},
    {"a", KodaExtensionVersion{2, 0}},
    {"f", KodaExtensionVersion{2, 0}},
    {"d", KodaExtensionVersion{2, 0}},
    {"c", KodaExtensionVersion{2, 0}},

    {"zfhmin", KodaExtensionVersion{1, 0}},
    {"zfh", KodaExtensionVersion{1, 0}},

    {"zba", KodaExtensionVersion{1, 0}},
    {"zbb", KodaExtensionVersion{1, 0}},
    {"zbc", KodaExtensionVersion{1, 0}},
    {"zbs", KodaExtensionVersion{1, 0}},

    {"zbkb", KodaExtensionVersion{1, 0}},
    {"zbkc", KodaExtensionVersion{1, 0}},
    {"zbkx", KodaExtensionVersion{1, 0}},
    {"zknd", KodaExtensionVersion{1, 0}},
    {"zkne", KodaExtensionVersion{1, 0}},
    {"zknh", KodaExtensionVersion{1, 0}},
    {"zksed", KodaExtensionVersion{1, 0}},
    {"zksh", KodaExtensionVersion{1, 0}},
    {"zkr", KodaExtensionVersion{1, 0}},
    {"zkn", KodaExtensionVersion{1, 0}},
    {"zks", KodaExtensionVersion{1, 0}},
    {"zkt", KodaExtensionVersion{1, 0}},
    {"zk", KodaExtensionVersion{1, 0}},

    {"v", KodaExtensionVersion{1, 0}},
    {"zvl32b", KodaExtensionVersion{1, 0}},
    {"zvl64b", KodaExtensionVersion{1, 0}},
    {"zvl128b", KodaExtensionVersion{1, 0}},
    {"zvl256b", KodaExtensionVersion{1, 0}},
    {"zvl512b", KodaExtensionVersion{1, 0}},
    {"zvl1024b", KodaExtensionVersion{1, 0}},
    {"zvl2048b", KodaExtensionVersion{1, 0}},
    {"zvl4096b", KodaExtensionVersion{1, 0}},
    {"zvl8192b", KodaExtensionVersion{1, 0}},
    {"zvl16384b", KodaExtensionVersion{1, 0}},
    {"zvl32768b", KodaExtensionVersion{1, 0}},
    {"zvl65536b", KodaExtensionVersion{1, 0}},
    {"zve32x", KodaExtensionVersion{1, 0}},
    {"zve32f", KodaExtensionVersion{1, 0}},
    {"zve64x", KodaExtensionVersion{1, 0}},
    {"zve64f", KodaExtensionVersion{1, 0}},
    {"zve64d", KodaExtensionVersion{1, 0}},
};

static const KodaSupportedExtension SupportedExperimentalExtensions[] = {
    {"zbe", KodaExtensionVersion{0, 93}},
    {"zbf", KodaExtensionVersion{0, 93}},
    {"zbm", KodaExtensionVersion{0, 93}},
    {"zbp", KodaExtensionVersion{0, 93}},
    {"zbr", KodaExtensionVersion{0, 93}},
    {"zbt", KodaExtensionVersion{0, 93}},
};
...
struct FindByName {
  ...
  StringRef Ext;
  bool operator()(const KodaSupportedExtension &ExtInfo) {
    return ExtInfo.Name == Ext;
  }
};

static Optional<KodaExtensionVersion> findDefaultVersion(StringRef ExtName) {
...
void KodaISAInfo::addExtension(StringRef ExtName, unsigned MajorVersion,
                                unsigned MinorVersion) {
  KodaExtensionInfo Ext;
...
static Optional<KodaExtensionVersion> isExperimentalExtension(StringRef Ext) {
  auto ExtIterator =
...
bool KodaISAInfo::isSupportedExtensionFeature(StringRef Ext) {
...
bool KodaISAInfo::isSupportedExtension(StringRef Ext) {
  return llvm::any_of(SupportedExtensions, FindByName(Ext)) ||
         llvm::any_of(SupportedExperimentalExtensions, FindByName(Ext));
}

bool KodaISAInfo::isSupportedExtension(StringRef Ext, unsigned MajorVersion,
                                        unsigned MinorVersion) {
  auto FindByNameAndVersion = [=](const KodaSupportedExtension &ExtInfo) {
...
bool KodaISAInfo::hasExtension(StringRef Ext) const {
...
bool KodaISAInfo::compareExtension(const std::string &LHS,
...
static Error getExtensionVersion(StringRef Ext, StringRef In, unsigned &Major,
  ...
  if (KodaISAInfo::isSupportedExtension(Ext, Major, Minor))
    return Error::success();
...
llvm::Expected<std::unique_ptr<KodaISAInfo>>
KodaISAInfo::parseFeatures(unsigned XLen,
                            const std::vector<std::string> &Features) {
  assert(XLen == 32 || XLen == 64);
  std::unique_ptr<KodaISAInfo> ISAInfo(new KodaISAInfo(XLen));
  ...
  return KodaISAInfo::postProcessAndChecking(std::move(ISAInfo));
}

llvm::Expected<std::unique_ptr<KodaISAInfo>>
KodaISAInfo::parseArchString(StringRef Arch, bool EnableExperimentalExtension,
                              bool ExperimentalExtensionVersionCheck) {
...
Error KodaISAInfo::checkDependency() {
  bool IsRv32 = XLen == 32;
...
void KodaISAInfo::updateImplication() {
  bool HasE = Exts.count("e") != 0;
...
void KodaISAInfo::updateMinVLen() {
  for (auto const &Ext : Exts) {
    StringRef ExtName = Ext.first;
...
void KodaISAInfo::updateMaxELen() {
...
std::string KodaISAInfo::toString() const {
  std::string Buffer;
...
std::vector<std::string> KodaISAInfo::toFeatureVector() const {
...
llvm::Expected<std::unique_ptr<KodaISAInfo>>
KodaISAInfo::postProcessAndChecking(std::unique_ptr<KodaISAInfo> &&ISAInfo) {
