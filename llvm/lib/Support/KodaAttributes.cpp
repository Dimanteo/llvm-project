//===-- KodaAttributes.cpp - Koda Attributes ----------------------------===//
//
...
using namespace llvm::KodaAttrs;
...
constexpr TagNameMap KodaAttributeTags{tagData};
const TagNameMap &llvm::KodaAttrs::getKodaAttributeTags() {
  return KodaAttributeTags;
}