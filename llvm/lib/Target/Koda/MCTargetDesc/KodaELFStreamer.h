//===-- KodaELFStreamer.h - Koda ELF Target Streamer ---------*- C++ -*--===//
//
...
#ifndef LLVM_LIB_TARGET_Koda_MCTARGETDESC_KodaELFSTREAMER_H
#define LLVM_LIB_TARGET_Koda_MCTARGETDESC_KodaELFSTREAMER_H
...
class KodaTargetELFStreamer : public KodaTargetStreamer {
private:
...
public:
  ...
  KodaTargetELFStreamer(MCStreamer &S, const MCSubtargetInfo &STI);
